...
valgrind --leak-check=full --track-origins=yes -v ../bin/weight4tfa -i 100Kallchr.tfa.gz -o 100Kallchr.tfa_weights.gz -g ./100Kallchr.gtf nonsynonymous Nuclear_Universal -n chr10,chr12,chr14 -l 50000,100000,75000 -G 2  2> valgrind02.txt
